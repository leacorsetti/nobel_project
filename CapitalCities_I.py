...
for dictionaries in countries:
    countries_edited.append([dictionaries['name']['common'], dictionaries['capital'], dictionaries['demonym']] + dictionaries['latlng'])

with open('processed_countries_1.csv', 'w', newline= '') as country:
